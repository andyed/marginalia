...
name: marginalia
description: >
  Typographic callout library for editorial-quality HTML output. Use when
  generating content that needs pull quotes, sidebars, margin notes, callouts,
  drop caps, code blocks, highlights, or magazine-style two-column layouts.
  Converts markdown patterns (GitHub-style alerts, blockquotes, ==highlights==,
  {badges}, footnotes) to styled components via marginalia-md.js.
---
